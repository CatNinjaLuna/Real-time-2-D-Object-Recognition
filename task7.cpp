...
Date: Oct/28/2024
File: task7.cpp
Purpose: This code file loads a database of known object feature vectors and 
classifies new objects by calculating Euclidean distances to known features, 
using scaled or unscaled metrics. It computes and prints confusion matrices 
to evaluate classification accuracy, helping validate object recognition against a labeled dataset.
*/
